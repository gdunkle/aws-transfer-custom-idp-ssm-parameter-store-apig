...
ZIP_FILE_NAME="aws-transfer-custom-idp-ssm-parameter-store-apig-$timestamp.zip"
LAYER_FILE_NAME="aws-transfer-custom-idp-ssm-parameter-store-apig-layer-$timestamp.zip"
cd ..
...
echo "------------------------------------------------------------------------------"
echo "[Build] aws-transfer-custom-idp-ssm-parameter-store-apig Function"
echo "------------------------------------------------------------------------------"
cd $source_dir/aws-transfer-custom-idp-ssm-parameter-store-apig

zip -r $build_dist_dir/$ZIP_FILE_NAME .


echo "------------------------------------------------------------------------------"
echo "[Build] aws-transfer-custom-idp-ssm-parameter-store-apig Layer"
echo "------------------------------------------------------------------------------"
